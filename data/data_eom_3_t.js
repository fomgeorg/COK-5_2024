...
const data = {
    "index_1":{
        "subtitle": "Выберите правильное расположение потоков на схем.",
    ...
    "index_9":{
        ...
        "test":[
            {"type": 1},
            {"answers": [
                "Температура верха – 70 &deg;С, низа – 35 &deg;С",
                "Температура верха – 160 &deg;С, низа – 190 &deg;С",
                "Температура верха – 350 &deg;С, низа – 280 &deg;С"
            ]},
            {"correct_answer": [0]},
    ...
    "index_12":{
        ...
        "test":[
            ...
            {"answers": [
                ...
                "Качество рафината улучшится",
                "Качество рафината не изменится"
            ]},
            {"correct_answer": [0]},
